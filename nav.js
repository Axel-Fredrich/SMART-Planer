...
var links = 
[{label: 'Spezifisch', bg: '#c0392b',href:"",  id:"spezifisch" }, 
 {label: 'Messbar', bg: '#16a085',  href: "messbar.html"}, 
 {label: 'Attraktiv', bg: '#8e44ad', href : "attraktiv.html"}, 
 {label: 'Realistisch', bg: "#27ae60", href:"realistisch.html"}, 
 {label: 'Terminiert', bg: '#f39c12', href: "terminiert.html"},
 {label: 'Verlassen', bg: '#000000', href:"index.html"}, 
 ];
 ...
 var radius = Math.min(windowHeight*0.6);
 ...
 function Popup() { 
  ...
  circle.style.width = radius*2 +'2px';
 circle.style.height = radius*2 +'2px';
...
function addEventListenerToLink() {
  ...
  let overlayLink = document.getElementById("spezifisch");
  ...
  if (overlayLink && overlayLink.parentNode === document.body) {
    overlayLink.addEventListener("click", function() {
      overlay.style.display = "block";
      console.log("Link clicked");
    });
  } else {
    console.log("Overlay link is not a direct child of document.body");
